...
interface CandidateStep3EnhancedProps {
  formData: {
    jobTitle: string
  ...
  updateFormData: (data: Partial<CandidateStep3EnhancedProps["formData"]>) => void
}

// Location input component with enhanced features
...
export function CandidateStep3Enhanced({ formData, updateFormData }: CandidateStep3EnhancedProps) {
