...
interface CandidateStep4Props {
  formData: {
    resume: File | null
    coverLetter: File | null
    additionalDocuments: File[]
  }
  updateFormData: (data: Partial<CandidateStep4Props["formData"]>) => void
}
...
export function CandidateStep4({ formData, updateFormData }: CandidateStep4Props) {
