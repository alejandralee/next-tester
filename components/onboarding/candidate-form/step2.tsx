...
interface CandidateStep2Props {
  ...
  updateFormData: (data: Partial<CandidateStep2Props["formData"]>) => void
}

export function CandidateStep2({ formData, updateFormData }: CandidateStep2Props) {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Helps us understand how to reach more great candidates</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Helps us prioritize your profile and send relevant opportunities
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-muted-foreground">Get priority access and special benefits with a referral code</p>
        </div>
      </div>
